  ...
  <div :class="['knob', 'style' + knob.style]">
    ...
    <div class="knob-dial" :style="{ color: knob.active ? knob.color : '#888' }">
      <div class="knob-labels">
        <div v-for="(option, index) in _options" :key="index" class="knob-label-anchor" :style="{ '--angle': option.angle }">
      ...
      <div class="dial-grip" :style="{ transform: 'translate(-50%,-50%) rotate(' + rotation + 'deg)' }" @mousedown="handleMouseDown" @wheel="handleMouseWheel" @dblclick="handleDbClick"></div>
