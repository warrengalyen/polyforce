  ...
  <div class="_synth">
    ...
    <div class="synth-control">
      <label>
        ...
        <input type="range" min="0" max="4" step="0.01" v-model.number="portamento" @input="synth.set('portamento', $event.target.value)" />
      </label>
      <label>
        <p>Master - ({{ volume }})</p>
        <input type="range" min="0" max="1" step="0.01" v-model.number="volume" @input="synth.setVolume($event.target.value)" />
      </label>
      <label>
        <p>Amp Env</p>
